...
public class Settings {
    ...
    public static int indent = 15, line = 20, linespace = 5, fontsize = 35, buttondist = 300,
            priorityLineLength = 200, statsgrid = 3, foldLimit = 7;
    ...
    public final static Font font = extractedFont(), donefont = doneFont(), statsfont = new Font("Ubuntu", Font.PLAIN, 150);
    ...
    public static void read() {
        ...
        for (Field field : Settings.class.getFields()) {
            ...
            if (jsonObject.has(name)) {
                try {
                    Object value = null;
                    if(field.getType().equals(Integer.TYPE)) value = jsonObject.get(name).getAsInt();
                    else if(field.getType().equals(Double.TYPE)) value = jsonObject.get(name).getAsDouble();
