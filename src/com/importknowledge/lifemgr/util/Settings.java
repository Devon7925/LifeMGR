...
public class Settings {
    ...
    public final static String dir = System.getProperty("user.home") + "/LifeMGR/", inpath = dir + "yay.list",
            outpath = dir + "yay.list", jsonpath = dir + "settings.json", fontpath = dir + "times.ttf",
