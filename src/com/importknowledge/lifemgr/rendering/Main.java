...
public class Main extends JFrame implements ActionListener {
    ...
    public Main() {
        Settings.read();
        if (new File(Settings.inpath).exists())
            list = deserialzeAddress(Settings.inpath);
        setLocation(20, 20);
        ...
        java.util.List<ListPanelType> panels = Arrays.asList(new ListPanel(list, this, Settings.outpath),
                new QuickPanel(list, this, Settings.outpath), new SortedPanel(list, this, Settings.outpath),
